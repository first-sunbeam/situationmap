...
export const formLabelsByLanguage = {
  ...
  en: {
    ...
    ui: {
      ...
      maskingSectionHint: "In PDA, masking is often an unconscious survival strategy – the child continues despite overload, followed by delayed escalation. Masking time + later escalation intensity show the cost of continuing to function.",
      maskingContinuedFor: "Continuing activity despite rising tension by",
      maskingGroupLegend: "Masking strategies and time continuing to function",
      maskingDurationFor: "Time continuing to function before escalation by",
