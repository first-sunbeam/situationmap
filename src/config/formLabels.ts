...
export const formLabelsByLanguage = {
  pl: {
    ...
    ui: {
      ...
      simpleStateHint: "Osoby autystyczne mogą mieć trudność z rozpoznaniem sygnałów z ciała (interocepcja) i z integracją bodźców zewnętrznych – to wpływa na próg dysregulacji.",
      ...
      baselineSectionHint: "Osoby autystyczne mogą mieć trudność z rozpoznaniem sygnałów z ciała (interocepcja) i z integracją bodźców zewnętrznych – obie grupy czynników wpływają na próg dysregulacji.",
  ...
  en: {
    ...
    simple: {
      ...
      adultReaction: "Support/environment response",
    ...
    ui: {
      ...
      currentEnvironment: "Fill in the form for environment:",
      ...
      localStorageNote: "Data is saved locally in this browser. Email opens in your default email app with prepared response content.",
      ...
      simpleStateHint: "Autistic people may have difficulty recognizing body signals (interoception) and integrating external stimuli – this affects the dysregulation threshold.",
      ...
      decisionPossibilityFor: "Possibility of decision for",
      ...
      baselineSectionHint: "Autistic people may have difficulty recognizing body signals (interoception) and integrating external stimuli – both affect the dysregulation threshold.",
      ...
      recoverySupportsHintPrefix: "Emotional calming ≠ cognitive readiness. The nervous system needs time to return to social engagement mode – this may take from minutes to hours. A quick outward “return to normal” with later evening/home escalation may mean continued masking in",
