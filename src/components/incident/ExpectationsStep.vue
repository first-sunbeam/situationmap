...
<template>
  <section class="section" :class="{ invalidSection: fieldErrors['incident.expectationsSection'] }">
    ...
    <fieldset class="field full">
      <legend class="field-label">{{ formLabels.incident.predictability }}</legend>
      <div class="field-grid">
        <SelectField v-model="form.incident.predictabilityWhat" :label="formLabels.incident.predictabilityWhat" :options="yesNoUnknown" />
        <SelectField v-model="form.incident.predictabilityDuration" :label="formLabels.incident.predictabilityDuration" :options="yesNoUnknown" />
        <SelectField v-model="form.incident.predictabilityChoice" :label="formLabels.incident.predictabilityChoice" :options="yesNoUnknown" />
      </div>
    </fieldset>
